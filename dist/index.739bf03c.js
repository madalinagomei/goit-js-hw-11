...
const lightbox = ()=>new (0, _simplelightboxDefault.default)(".photo-card a", {
        captionsData: "alt",
        captionDelay: 250
    });
...
async function onSubmit(e) {
    e.preventDefault();
    const form = e.target;
    (0, _api.options).params.q = form.elements.searchQuery.value;
    if ((0, _api.options).params.q === "") {
        (0, _notiflixNotifyAio.Notify).info("Fill in the search input!");
        photosGallery.innerHTML = "";
        return;
    }
    (0, _api.options).params.page = 1;
    photosGallery.innerHTML = "";
    try {
        const response = await (0, _axiosDefault.default).get((0, _api.baseUrl), (0, _api.options));
...
async function getMorePhotos() {
    ...
    try {
        ...
        const totalHits = response.data.totalHits;
        getPhotos(hits);
        if ((0, _api.options).params.page * (0, _api.options).params.per_page >= totalHits) {
            moreButton.style.display = "none";
...
},{"axios":"jo6P5","./api":"9u7qN","notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const API_KEY = "42294787-218c53a6cef21d155db2a680c";
const options = {
    params: {
        key: API_KEY,
        image_type: "photo",
